...
public class MainActivity extends AppCompatActivity {
    ...
    private enum MenuStates {
        PATIENT_INFO, DATA_PACKET, LIST_DATA_PACKET, HEARTRATE, RECORD_VIDEO, SEND_FILE, NAVIGATION_MAP, UPDATE_PATIENT_INFO, DOCTOR_INFO, UPDATE_DOCTOR_INFO,VIEW_MYDOCTORS, LIST_PATIENT
    }
